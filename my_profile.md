...
## About me
Halo, perkenalkan saya Fathin Zhafira Fauzi. Lulusan dari S1 Teknik Komputer Universitas Diponegoro. Memiliki ketertarikan dalam bidang pengembangan website dan aplikasi mobile. 
Selain itu, saya juga tertarik dalam bidang Artificial Intelligence (Kecerdasan Buatan) dalam pengembangan aplikasi mobile yang dimana pada saat Tugas Akhir dengan judul "Pembuatan sistem 
prediksi kematangan dan nilai gizi pisang dengan metode CNN berbasis Aplikasi mobile dengan menggunakan kerangka kerja React Native dan Flask API". 
